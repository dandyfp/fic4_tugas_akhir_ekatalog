  ...
  Widget build(BuildContext context) {
    return Scaffold(
                    ...
                    child: ListTile(
                      ...
                      trailing: InkWell(
                        onTap: () {
                          ...
                          formProduct(context: context, isEdit: true, id: product.id);
                        },
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          formProduct(context: context, isEdit: false);
        },
                  ...
                  builder: (context, state) {
                    ...
                    return ElevatedButton(
                      onPressed: () {
                        ...
                        isEdit == false
                            ? context.read<CreateProductBloc>().add(DoCreateProductEvent(productModel: productModel))
                            : context.read<UpdateProductBloc>().add(DoUpdateProductEvent(productModel: productModel, id: id!));
